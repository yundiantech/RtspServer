...
$(TARGET_TEST_EXAMPLE_H264_RTSP_SERVER) : $(OBJ_EXAMPLE_H264_RTSP_SERVER) $(OBJS_BASE) $(OBJS_NET) $(OBJS_FRAME)
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)

$(TARGET_TEST_EXAMPLE_AAC_RTSP_SERVER) : $(OBJ_EXAMPLE_AAC_RTSP_SERVER) $(OBJS_BASE) $(OBJS_NET) $(OBJS_FRAME)
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)

$(TARGET_TEST_EXAMPLE_H264_AAC_RTSP_SERVER) : $(OBJ_EXAMPLE_H264_AAC_RTSP_SERVER) $(OBJS_BASE) $(OBJS_NET) $(OBJS_FRAME)
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)

$(TARGET_TEST_EXAMPLE_V4L2_RTSP_SERVER) : $(OBJ_EXAMPLE_V4L2_RTSP_SERVER) $(OBJS_BASE) $(OBJS_NET) $(OBJS_FRAME) $(OBJS_EXTEND_V4L2)
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)

$(TARGET_TEST_EXAMPLE_ALSA_RTSP_SERVER) : $(OBJ_EXAMPLE_ALSA_RTSP_SERVER) $(OBJS_BASE) $(OBJS_NET) $(OBJS_FRAME) $(OBJS_EXTEND_ALSA)
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)

$(TARGET_TEST_EXAMPLE_MYEXAMPLE) : $(OBJ_EXAMPLE_MYEXAMPLE) $(OBJS_BASE) $(OBJS_NET) $(OBJS_FRAME) $(OBJS_PATH)/RtspStreamManager.o
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)
